...
Forward methods: `DIRECT`, `PROXYCHAIN`, `ZIA`, `ZPA`, `ECZPA`, `ECSELF`, `DROP`, `ENATDEDIP` (default), `GEOIP`. Repeatable: `--group-id`, `--group-name`, `--category-id`, `--category-name`, `--dest-address`, `--dest-ip-group-id`, `--dest-ip-group-name`. URL categories map to `destIpCategories`.
