...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  📊 RAPPORT QUOTIDIEN — $HOSTNAME (macOS)"
echo "  $TODAY"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "ℹ️  Instantané au moment de l'exécution (macOS n'a pas d'historique sar)."
echo ""
...
echo "▸ Instantané — User: ${CPU_USER}% | System: ${CPU_SYS}% | Idle: ${CPU_IDLE}%"
...
echo "▸ Utilisation : ${USED_PCT}%  (${USED_MB} MB used | ${AVAIL_MB} MB dispo)"
echo "▸ Wired: ${WIRED_MB} MB | Compressée: ${COMP_MB} MB"
...
if df -h /System/Volumes/Data >/dev/null 2>&1; then
    df -h /System/Volumes/Data | tail -1 | awk '{printf "▸ /System/Volumes/Data — Taille: %s | Used: %s (%s) | Free: %s\n", $2, $3, $5, $4}'
fi
echo ""

# ── TOP PROCESSES ──
echo "── 🔄 PROCESSUS ──"
echo "▸ Total : $(($(ps ax | wc -l) - 1)) processus"
